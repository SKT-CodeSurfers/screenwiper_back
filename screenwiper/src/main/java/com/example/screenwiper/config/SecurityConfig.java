        ...
        http
                ...
                .authorizeHttpRequests(authorizeRequests ->
                        authorizeRequests
                                ...
                                .requestMatchers(GET, "/api/members/me").permitAll() // 홈 유저 정보 조회 허용
                                ...
                                .requestMatchers(PUT, "/api/images/detect/{photoId}").permitAll()
                                .requestMatchers(GET, "/api/images/detect/{photoId}").permitAll()
                                .requestMatchers(GET, "/api/images/similar/{photoId}").permitAll()
